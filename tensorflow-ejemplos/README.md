This code and example is not mine, I used and modified it
Go [here](https://github.com/aymericdamien/TensorFlow-Examples/) for source
Every link above is linked to the real source.
